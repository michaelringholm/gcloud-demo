...
public class ServiceRegistryController {
   ...
   */
	...
	public @ResponseBody Object insert(@RequestBody Service service) {
		...
		//return new Object(){ public String status="success"; public String message="Service registered!"; public long id=serviceId; };
		return new Object(){ public int status=HttpStatus.OK.value(); public String message="Service registered!"; public long id=serviceId; };
	}
	...
	public @ResponseBody Object update(@RequestBody Service service) {
		...
		System.out.println(success);
		final long serviceId = service.getId();
		return new Object(){ public int status=HttpStatus.OK.value(); public String message="Service updated!"; public long id=serviceId; };
	}
	...
	public @ResponseBody Object delete(String name) {
		...
		System.out.println(success);
		return new Object(){ public int status=HttpStatus.OK.value(); public String message="Service deleted!"; };
	}  	
  	...
  	/***
  	 * For query syntax please see https://cloud.google.com/datastore/docs/reference/gql_reference
  	 * curl http://localhost:8080/findByName?name=Sports%20Results
  	 * @param serviceName
  	 * @return
  	 */
  	@RequestMapping(value="/find", method=RequestMethod.GET)
  	private @ResponseBody Object find(String serviceName) {
  		List<Service> servicesFound = null;
  		/*EntityQueryRequest request = entityManager.createEntityQueryRequest("SELECT * FROM service WHERE name = @name");
	  	request.setNamedBinding("name", serviceName);
	  	QueryResponse<Service> response = entityManager.executeEntityQueryRequest(Service.class, request);
	  	servicesFound = response.getResults();*/
        ...
        for (ScoredDocument document : results) {
	  	...
	  	return new Object(){ public int status=HttpStatus.OK.value(); public List<Service> services=servicesFound; };
  	}    	
